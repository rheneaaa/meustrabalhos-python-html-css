...
def Conectar():#Função faz a conexão com o Banco tem que estar em todas as outra Funções
    try:
...
def zueira():
    ...
    img = PhotoImage(file="images/golle.png")
